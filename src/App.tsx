...
import { AdminLayout, TeacherLayout, StudentLayout } from "@/components/layout";
      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/admin/maestros" element={<AdminLayout><Maestros /></AdminLayout>} />
            ...
            <Route path="/admin/asignaturas" element={<AdminLayout><Asignaturas /></AdminLayout>} />
            <Route path="/admin/asignaciones" element={<AdminLayout><Asignaciones /></AdminLayout>} />
            ...
            {/* Student Routes */}
            <Route path="/alumno" element={<StudentLayout><StudentDashboard /></StudentLayout>} />
            <Route path="/alumno/cursos" element={<StudentLayout><StudentCourses /></StudentLayout>} />
            <Route path="/alumno/curso/:id" element={<StudentCourseViewer />} />
            <Route path="/alumno/examenes" element={<StudentLayout><StudentExams /></StudentLayout>} />
            <Route path="/alumno/calificaciones" element={<StudentLayout><StudentGrades /></StudentLayout>} />
