    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="page-description">Gestiona los estudiantes registrados en la plataforma</p>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="stat-card">
          ...
          <p className="text-2xl font-semibold text-foreground">{alumnosData.length}</p>
        </div>
        <div className="stat-card">
          <p className="text-sm text-muted-foreground">Activos</p>
          <p className="text-2xl font-semibold text-success">{alumnosData.filter(a => a.estado === "activo").length}</p>
        </div>
        <div className="stat-card">
          <p className="text-sm text-muted-foreground">Inactivos</p>
          <p className="text-2xl font-semibold text-muted-foreground">{alumnosData.filter(a => a.estado === "inactivo").length}</p>
        </div>
        <div className="stat-card">
          <p className="text-sm text-muted-foreground">Grados</p>
          <p className="text-2xl font-semibold text-primary">{grados.length}</p>
        </div>
      </div>
              ...
              >
                ...
                <TableCell>
                  <Badge
                    ...
                    className={alumno.estado === "activo" ? "bg-success/10 text-success hover:bg-success/20" : ""}
                  >
